...
/**************************************************************************
  ...
  Summary:
    ...
    (usb_device_config.h user option) the USBDeviceTasks() function should be called 
...
/**************************************************************************
    ...
    Precondition:
        ...
        section if USB_POLLING mode option is being used (usb_device_config.h option).
...
/*******************************************************************************
  ...
  Summary: Calling this function will prevent the USB stack from automatically
            ...
            1.  If the "USB_ENABLE_STATUS_STAGE_TIMEOUTS" option is commented in
                usb_device_config.h, then the status stage of the control transfer will
            ...
            2.  If the "USB_ENABLE_STATUS_STAGE_TIMEOUTS" option is enabled in 
                usb_device_config.h, then the USBDeviceTasks() function will 
...
/*******************************************************************************
  ...
  Summary: Returns true if a control transfer with OUT data stage is pending,
           ...
           USB_INTERRUPT option selected in usb_device_config.h), but the firmware
